...
#define PARAM_SAVED_START_ADDRESS 				ADDR_FLASH_SECTOR_23        //flash最后一个扇区
...
extern void AppParamInit(void);
extern uint8_t AppParamSave(void);
...
//读取calidata保存到gAppParam中，并写入到Flash中
